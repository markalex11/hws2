...
export const pureAddUserCallback = (name: string, setUsers: (newAr:Array<UserType>) => void, users: Array<UserType>) => { // need to fix any DONE
    const user = { _id: v1() , name: name // need to fix  DONE
    }
    setUsers([...users, user])
}
