...
function Clock() {
    ...
    const start = () => {
        ...
        let timerId2 = setInterval(() => setDate(new Date()), 1000)
        setTimerId(Number(timerId2))
    }
    ...
    // тэг бр для того чтобы сайт не дергался когда нет даты этот тег заменяет одну строку текста
